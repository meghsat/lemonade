...
class Keys:
    ...
    TTFT_WITHOUT_OVERHEAD = "ttft_without_overhead"
    STD_DEV_TTFT_WITHOUT_OVERHEAD = "std_dev_ttft_without_overhead"
    TOKENIZATION_OVERHEAD = "tokenization_overhead"
    STD_DEV_TOKENIZATION_OVERHEAD = "std_dev_tokenization_overhead"
    GENERATOR_CREATION_OVERHEAD = "generator_creation_overhead"
    STD_DEV_GENERATOR_CREATION_OVERHEAD = "std_dev_generator_creation_overhead"
